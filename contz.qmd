...
[{{< fa envelope size=5x >}}]{style="color:red"} kamspatial\@gmail.com

[{{< fa brands facebook size=5x >}}]{style="color:red"} kampspatial

[{{< fa brands instagram size=5x >}}]{style="color:red"} @kampspatial

[{{< fa brands twitter size=5x >}}]{style="color:red"} @kampspatial

[{{< fa brands linkedin size=5x >}}]{style="color:red"} kampspatial

[{{< fa brands whatsapp size=5x >}}]{style="color:red"} [KampSpatial](https://web.whatsapp.com/ "Whatsapp"){.uri}
